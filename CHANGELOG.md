...
### Cowork VM deps recommended (matching upstream); README slimmed (3P + env-vars moved to docs)
...
- **README Installation section reworked for a quicker start** - the base install now notes Cowork's VM deps come in by default, leaving just the two manual steps up top instead of buried in the Cowork section.
