(function(){
  ...
  var _sockName=globalThis.__coworkKvmMode?"cowork-kvm-service.sock":"cowork-vm-service.sock";
  ...
  console.log("[claude-cowork] mode="+_mode+(envBackend?" (COWORK_VM_BACKEND set)":autoMode==="kvm"?" (auto: kvm socket present)":" (auto: native default)")+", service="+(globalThis.__coworkServiceAvailable?"available":"not found"));
