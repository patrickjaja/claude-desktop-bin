...
echo "darwin: $(rg -o 'platform==="darwin"' "$NEW" | wc -l)"   # baseline v1.17282.0: 78 (v1.15962.0: 76, v1.15200.0: 76, v1.14271.0: 73, v1.13576.0: 77, v1.12603.1: 79, v1.11847.5: 73, v1.10628.0: 65; 76->78 = minify reorg + macOS-version capability-check restructure, not features)
echo "win32:  $(rg -o 'platform==="win32"'  "$NEW" | wc -l)"   # baseline v1.17282.0: 127 (v1.15962.0: 125, v1.15200.0: 125, v1.14271.0: 124, v1.13576.0: 137, v1.12603.1: 141, v1.11847.5: 122; 125->127 = vendored UNC/drive-letter path-normalization helpers, not features)
echo "linux:  $(rg -o 'platform==="linux"'  "$NEW" | wc -l)"   # baseline v1.17282.0: 12 (v1.15962.0: 10, v1.15200.0: 10, v1.14271.0: 10, v1.13576.0: 10, v1.12603.1: 9, v1.11847.5: 5; 10->12 = re-vendored signal-exit Linux signal table SIGIO/SIGPOLL/SIGPWR + efivars.fd darwin||linux push, not features)
...
rg -o '.{0,80}status:"unavailable".{0,40}' "$NEW" | sort -u   # baseline v1.17282.0: 31 (v1.15962.0: 30, v1.15200.0: 30; 30->31 = one new key spaceMemoryBridge, flag-gated, no platform check - see STUB table)
# (strict process.platform!=="darwin" count: v1.17282.0: 42, v1.15962.0: 40 - +2 from macOS-version capability-check restructure, not features)
```
