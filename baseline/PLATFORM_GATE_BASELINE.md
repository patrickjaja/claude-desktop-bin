...
echo "darwin: $(rg -o 'platform==="darwin"' "$NEW" | wc -l)"   # baseline v1.15200.0: 76 (v1.14271.0: 73, v1.13576.0: 77, v1.12603.1: 79, v1.11847.5: 73, v1.10628.0: 65; +3 vs v1.14271 = re-minify churn + new getExternalRelayConfig)
echo "win32:  $(rg -o 'platform==="win32"'  "$NEW" | wc -l)"   # baseline v1.15200.0: 125 (v1.14271.0: 124, v1.13576.0: 137, v1.12603.1: 141, v1.11847.5: 122; +1 = same churn)
echo "linux:  $(rg -o 'platform==="linux"'  "$NEW" | wc -l)"   # baseline v1.15200.0: 10 (v1.14271.0: 10, v1.13576.0: 10, v1.12603.1: 9, v1.11847.5: 5)
