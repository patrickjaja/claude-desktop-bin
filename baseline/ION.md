...
**Last verified:** 2026-06-17 against v1.13576.0 (major bump v1.12603.1 -> v1.13576.0, full re-minify; **no structural changes** - 95 MB / 730 JS / 956 files / 25 CSS; config chunk content-hash bump `c71860c77-upcFhKtF.js` -> `c71860c77-DXc_sfB9.js` (~305 KB), `mountPath` still mac/win-only (no `linux` key) so `fix_ion_dist_linux.nim` still required and both sub-patterns matched; platform-ternary vars now `_`/`M`/`yt` (`_===M.Win32?yt.mountPath.win:yt.mountPath.mac`); darwin-gated file count 11 -> 10; new 3P config keys: Vertex `inferenceVertexProjectId`/`inferenceVertexRegion`/`inferenceVertexWorkforceOidc`/`inferenceVertexWorkforceUserProject` and Gateway `inferenceGatewayBaseUrl`/`inferenceGatewayHeaders`. Prior: v1.12603.1 = 94 MB / 730 JS / 978 files / 25 CSS (config chunk `c71860c77-upcFhKtF.js`; ternary vars `V`/`E`/`xt`); v1.12603.0 = 94 MB / 730 JS / 979 files / 25 CSS (config chunk `c71860c77-C2vlLTGm.js`; platform-ternary vars `V`/`E`/`xt`); v1.11847.5 = 93 MB / 715 JS / 961 files / 23 CSS (platform-ternary vars `V`/`E`/`yt`; `caption` key dropped from `mountPath`); v1.11187.4 = 92 MB / 706 JS / 950 files / 23 CSS (platform-ternary vars `K`/`C`/`pt`); v1.10628.2 = 90 MB / 691 JS / 909 files / 21 CSS (re-minify of v1.10628.0; major bump from v1.9659.4 = 88 MB / 682 JS / 899 files).
...
| Metric | Value |
|--------|-------|
| Total size | 95 MB (v1.13576.0; was 94 MB in v1.12603.0, 93 MB in v1.11847.5, 92 MB in v1.11187.4, 90 MB in v1.10628.0, 88 MB in v1.9659.4) |
| JS chunks | 730 JS total, 956 files total (v1.13576.0; was 730 JS / 979 files in v1.12603.0, 715 JS / 961 files in v1.11847.5, 706 JS / 950 files in v1.11187.4, 691 JS / 909 files in v1.10628.0) |
| CSS | 25 files (v1.13576.0; was 25 in v1.12603.0, 23 in v1.11847.5, 21 before v1.11187.4) |
...
| `assets/v1/c71860c77-*.js` | 19 files (main: ~305 KB) | 3P config UI, code-split into lazy-loaded chunks - **main chunk patched** (v1.13576.0: `c71860c77-DXc_sfB9.js`; v1.12603.1: `c71860c77-upcFhKtF.js`; v1.12603.0: `c71860c77-C2vlLTGm.js`; v1.11847.5: `c71860c77-BBQ3iytl.js`; v1.11187.4: `c71860c77-CyMvMS7K.js`; v1.10628.2: `c71860c77-CV0D52ti.js`; v1.10628.0: `c71860c77-CDhE5jkR.js`; v1.9659.1/v1.9659.2/v1.9659.4: `c71860c77-BOyfE2Py.js`; v1.9255.2: `c71860c77-DFJHDHrp.js`) |
