...
**Last verified:** 2026-06-02 against v1.9659.4 (point release on v1.9659.2; ion-dist bundle byte-identical: same chunk hashes, 88 MB / 682 JS / 899 files)
...
| `assets/v1/c71860c77-*.js` | 21 files (main: ~280 KB) | 3P config UI, code-split into lazy-loaded chunks - **main chunk patched** (v1.9659.1/v1.9659.2/v1.9659.4: `c71860c77-BOyfE2Py.js`; v1.9255.2: `c71860c77-DFJHDHrp.js`) |
