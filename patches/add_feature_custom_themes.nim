...
"--text-000":"300 100% 98%","--text-100":"300 100% 98%","--text-200":"312 100% 85%","--text-300":"312 100% 85%","--text-400":"300 17% 65%","--text-500":"300 18% 64%",
...
"--oncolor-100":"285 50% 8%","--oncolor-200":"285 50% 8%","--oncolor-300":"285 50% 8%",
...
"--claude-text-100":"#fff5ff","--claude-text-200":"#ffb4f0","--claude-text-400":"#b496b4","--claude-text-500":"#a487a4","--claude-description-text":"#ff8ce6"
},
"nord":{
"--bg-000":"220 16% 22%","--bg-100":"222 16% 18%","--bg-200":"220 17% 14%","--bg-300":"220 16% 12%","--bg-400":"220 16% 8%","--bg-500":"220 16% 6%",
"--text-000":"218 27% 94%","--text-100":"218 27% 94%","--text-200":"219 28% 88%","--text-300":"219 28% 88%","--text-400":"219 18% 66%","--text-500":"219 18% 66%",
...
"--oncolor-100":"220 16% 15%","--oncolor-200":"220 16% 15%","--oncolor-300":"220 16% 15%",
...
"--claude-text-100":"#ECEFF4","--claude-text-200":"#D8DEE9","--claude-text-400":"#9aa0ae","--claude-text-500":"#9aa0ae","--claude-description-text":"#B9BFCB"
},
"catppuccin-mocha":{
...
"--oncolor-100":"240 21% 12%","--oncolor-200":"240 21% 12%","--oncolor-300":"240 21% 12%",
...
"--text-000":"227 70% 87%","--text-100":"227 70% 87%","--text-200":"227 44% 80%","--text-300":"227 44% 80%","--text-400":"228 28% 77%","--text-500":"228 28% 77%",
...
"--oncolor-100":"229 19% 20%","--oncolor-200":"229 19% 20%","--oncolor-300":"229 19% 20%",
...
"--text-000":"234 16% 35%","--text-100":"234 16% 35%","--text-200":"233 13% 41%","--text-300":"233 13% 41%","--text-400":"233 13% 41%","--text-500":"233 13% 41%",
...
"--claude-text-100":"#4c4f69","--claude-text-200":"#5c5f77","--claude-text-400":"#6c6f85","--claude-text-500":"#6c6f85","--claude-description-text":"#5c5f77"
},
...
"--oncolor-100":"232 23% 15%","--oncolor-200":"232 23% 15%","--oncolor-300":"232 23% 15%",
...
+".dframe-content,.dframe-main{background-color:hsl(var(--bg-100))!important}"
+":root,.cds-root,.epitaxy-root,[data-mode=dark]{--cds-surface-0:hsl(var(--bg-100))!important;--cds-surface-1:hsl(var(--bg-200))!important;--cds-surface-2:hsl(var(--bg-100))!important;--cds-surface-3:hsl(var(--bg-000))!important;--cds-surface-popover:hsl(var(--bg-000))!important;--cds-surface-panel:hsl(var(--bg-100))!important;--cds-page-bg:hsl(var(--bg-100))!important;--surface-primary:hsl(var(--bg-100))!important;--surface-primary-elevated:hsl(var(--bg-300))!important;--surface-popover:hsl(var(--bg-000))!important;--surface-panel:hsl(var(--bg-100))!important;--surface-hud:hsl(var(--bg-200))!important}"
