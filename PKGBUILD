...
source_x86_64=("claude-desktop-${pkgver}-${pkgrel}-linux.tar.gz::https://github.com/patrickjaja/claude-desktop-bin/releases/download/v1.1.4328/claude-desktop-1.1.4328-linux.tar.gz")
sha256sums_x86_64=('eb113dba95009b43e5130fa7cb46b5fb10341f125501f8a36148ed6e914db9d2')
options=('!strip')
